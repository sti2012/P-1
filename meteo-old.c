	...
	* 	librerias usadas:
	* 		cURL: 		Descarga una direccion de internet.
	* 		libxml2: 	Obtiene los datos del XML.
	* 
	* cURL descargara la prevision del tiempo de la API de google
	* libxml2 se encargara de quitar el formato XML para devolver solo datos
	* Se mostrara el resultado meteorologico de la ciudad en pantalla
	*
	* Dos formas de uso:
